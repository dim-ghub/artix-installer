...
pkgs="base base-devel $MY_INIT sysvinit elogind-$MY_INIT efibootmgr limine btrfs-progs wget dhcpcd wpa_supplicant connman-$MY_INIT hyprland kitty nano sddm sddm-openrc"
